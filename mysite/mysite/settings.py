...
SECRET_KEY = 'django-insecure-v1l&afm@mw=xh+53v^)3w939q#-p@ss1qd-%z0qf!%b&vuu&z#'
...
INSTALLED_APPS = [
    ...
    'taggit', # Теги
    'django.contrib.sites', # Карта сайта для поисковиков
    'django.contrib.sitemaps', # Карта сайта для поисковиков
